...
const DangerZone = () => {
  return (
    <motion.div
      className="backdrop-filter backdrop-blur-lg shadow-lg rounded-xl p-6 border border-red-700 mb-8"
      style={{ backgroundColor: "rgba(153, 27, 27, 0.5)" }} // Using rgba for bg-opacity
